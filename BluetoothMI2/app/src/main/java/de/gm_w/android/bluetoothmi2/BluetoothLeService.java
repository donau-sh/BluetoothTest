...
public class BluetoothLeService extends Service {
    ...
    public final static UUID UUID_HEART_RATE_CONTROL_POINT =
            UUID.fromString(SampleGattAttributes.HEART_RATE_CONTROL_POINT);
    public final static UUID UUID_HEART_BODY_SENSOR_LOCATION =
...
*/
        ...
        // connect the device directly, setting the autoConnect parameter to false.
        mBluetoothGatt = device.connectGatt(this, false, mGattCallback);
        Log.d(TAG, "Traing to create a new connection.");
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapater not initialized.");
            return;
        }
     ...
     * This should be invoked only after {@code BluetoothGatt#discoverServices()}
