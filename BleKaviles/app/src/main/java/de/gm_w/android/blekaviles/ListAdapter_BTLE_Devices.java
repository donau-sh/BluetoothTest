 ...
 * Use this Adapter to update the user interface as our device
 * detects BLE devices and add them to our lists.
 */
public class ListAdapter_BTLE_Devices extends ArrayAdapter<BTLE_Device> {
    ...
    public ListAdapter_BTLE_Devices(Activity activity, int resource,
                                    ArrayList<BTLE_Device> objects) {
